...
Utilize this input parameter to disable commenting with the preview URL as needed, like for matrix strategy(multiple job runs), and handle all of the deploy outputs manually.
